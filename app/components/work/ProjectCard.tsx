            ...
            >
                ...
                <div
                    className={`absolute text-white  ${
                        !(id % 2 === 0)
                            ? "right-0 top-32 mr-0 ml-10 md:right-0 md:ml-0 lg:right-0 lg:top-20  lg:mr-4"
                            : "left-10 top-32 ml-0 md:mr-12 lg:top-20 lg:ml-4"
                ...
                >
                    ...
                    <AnimatedBody
                        text={description}
                        className={
                            "mt-4 w-[90%] max-w-[457px] text-[20px] font-semibold text-[#95979D] "
                        }
                    />
                </div>
            </Container>
